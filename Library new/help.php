...
<?php include("top.php");?> 
  ...
  <!-- Content wrapper div starts here-->
    ...
    <h1>Help</h1>
    <p>For enquiries and complaint send message to yusuftech@gmail.com. </p>
    <p>Developed by: Yusuf In Award of Bsc In Computer Sience Alhikmah University Ilorin Kwara State  2013</p>
    </div>
